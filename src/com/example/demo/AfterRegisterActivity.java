...
public class AfterRegisterActivity extends ActionBarActivity implements View.OnClickListener{
	public static final String Server ="http://192.168.2.133:8080/WebApplication6/loginServlet";
	EditText password, email;
	Button login;
	TextView regLink, alert, name;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
		...
		regLink=((TextView) findViewById(R.id.regLink));
		  name= ((TextView) findViewById(R.id.name));
			name.setText("Succesfully registered!");
			alert.setText("Please enter your email and password");
			regLink.setVisibility(View.GONE);
